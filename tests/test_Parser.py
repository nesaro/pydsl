...
class TestParsers(unittest.TestCase):
    def setUp(self):
        from ColonyDSL.Type.Grammar.Parser.Symbol import CharTerminalSymbol, WordTerminalSymbol, NonTerminalSymbol, BoundariesRules, NullSymbol
        from ColonyDSL.Type.Grammar.Parser.Production import TerminalProduction, NonTerminalProduction, ProductionSet
    ...
    #    from ColonyDSL.Type.Grammar.Parser.RecursiveDescent import RecursiveDescentParser
    ...
    #    from ColonyDSL.Grammar.Parser.LR0Parser import LR0Parser
    ...
    #    from ColonyDSL.Type.Grammar.Parser.Weighted import WeightedParser
...
#    def setUp(self):
#        from ColonyDSL.Value.Information import Information
#        self.dots = Information("..................................")
#        from ColonyDSL.Memory.External.FileLibrary.BNF import strlist_to_production_set
#        self.productionsetlr,_ = strlist_to_production_set(leftrecursive)
#        self.productionsetrr,_ = strlist_to_production_set(rightrecursive)
#        self.productionsetcr,_ = strlist_to_production_set(centerrecursive)

    #def testLeftRecursion(self):
    #    from ColonyDSL.Type.Grammar.Parser.WeightedParser import WeightedParser
    #    parser = WeightedParser(self.productionsetlr)
    #    result = parser.check_word(self.dots)
    #    self.assertTrue(result)

    #def testMixResults(self):
    #    from ColonyDSL.Type.Grammar.Parser.Parser import mix_results 
    #    from ColonyDSL.Type.Grammar.Tree import ParserTreeNode
    #    from ColonyDSL.Abstract import TypeCheckList
    #    from ColonyDSL.Type.Grammar.Symbol import NullSymbol
