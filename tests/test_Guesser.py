...
class TestGuesser(unittest.TestCase):
    ...
    def testStuff(self):
        ...
        guesser = Guesser()
        self.assertListEqual(sorted(list(guesser('1234'))), sorted(['IntegerTree','cstring','hex','unixFilename','integer','calc_ply','ascii', 'test_alphabet', 'australian_postcode','swiss_postcode']))
