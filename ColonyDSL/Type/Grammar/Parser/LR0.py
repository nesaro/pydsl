...
import logging
LOG = logging.getLogger("LR0Parser")
from .Production import NonTerminalProduction
from ColonyDSL.Type.Grammar.Parser.Parser import BottomUpParser
from ColonyDSL.Type.Grammar.Symbol import NonTerminalSymbol, TerminalSymbol, EndSymbol, Symbol
...
def __slr_build_parser_table(productionruleset):
    ...
    for itemindex in range(len(statesset)):
        ...
        for symbol in productionruleset.getTerminalSymbols() + [EndSymbol]:
            ...
            if numberoptions > 1:
                from ColonyDSL.Exceptions import LRConflictException
