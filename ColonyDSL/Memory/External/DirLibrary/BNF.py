...
import logging
import re
from ColonyDSL.Type.Grammar.Parser.Symbol import StringTerminalSymbol, CharTerminalSymbol, WordTerminalSymbol, BoundariesRules, NonTerminalSymbol, NullSymbol
from ColonyDSL.Type.Grammar.Parser.Production import NonTerminalProduction
...
def strlist_to_production_set(linelist):
    ...
    for line in linelist:
        ...
        if re.search("::=", cleanline):
            ...
            from ColonyDSL.Type.Grammar.Parser.Production import TerminalProduction
